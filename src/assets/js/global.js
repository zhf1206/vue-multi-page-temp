...
import 'static/js/templatemo_custom.js';
import 'static/js/bootstrap-collapse.js';
...
//获取飞行时长
Vue.filter('getFlightTime',function (date,time,date_,time_) {
  let minutes = differenceInMinutes(date_+' '+time_,date+' '+time);
